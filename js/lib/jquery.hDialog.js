	...
	methods = {
           	...
           	return this.each(function() {
                ...
                if(typeof(_O) == 'undefined') {
	                	var defaults = {
	                		title: '',              	    //弹框标题
						box: '#HBox',               //弹框默认选择器
						boxBg: '#F7F7F7',           //弹框默认背景颜色
						modalBg: 'rgba(0,0,0,0.1)', //遮罩默认背景颜色
        ...
        open: function (o,T) {
			...
			if(o.types == 2){ iframeTpl = '<iframe width="' + o.width + '" height="' + o.height + '" frameborder="0" scrolling="auto" src="' + o.iframeSrc + '"></iframe>'; $B.append('<div id="'+o.iframeId+'"></div>'); $obj = $('#'+o.iframeId); }
        		...
        		$B.stop().append(overlayTpl).find($obj).css({'background-color':'#F7F7F7','position':'fixed','top':t,'left':l,'z-index':999999,'margin':m,'width':o.width,'height':o.height,'box-shadow':'0 0 10px rgba(0,0,0,.5)'}).removeAttr('class').addClass('animated '+c).prepend(headTpl+closeBtnTpl+iframeTpl).show();
